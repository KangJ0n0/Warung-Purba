    ...
    <section class="bg-blue-100 py-16">
        <div class="container mx-auto flex flex-col md:flex-row items-center">
            ...
            <div class="md:w-1/2 mt-8 md:mt-0">
                <img src="https://placehold.co/400x400" alt="Delicious food with rice and vegetables on a plate">
            </div>
        </div>
    </section>
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-4 bg-blue-100">
                        <h3 class="text-lg font-semibold">Nama Warung</h3>
                        <p class="text-gray-600">Rating Warung</p>
                    </div>
                </div>
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <img src="https://placehold.co/300x200" alt="A street food stall with various foods">
                    <div class="p-4 bg-blue-100">
                        <h3 class="text-lg font-semibold">Nama Warung</h3>
                        <p class="text-gray-600">Rating Warung</p>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <img src="https://placehold.co/300x200" alt="People enjoying food at a warung">
                    <div class="p-4 bg-blue-100">
                        <h3 class="text-lg font-semibold">Nama Warung</h3>
                        <p class="text-gray-600">Rating Warung</p>
                    </div>
